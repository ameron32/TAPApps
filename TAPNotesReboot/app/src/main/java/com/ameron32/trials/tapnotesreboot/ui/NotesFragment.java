...
import com.ameron32.trials.tapnotesreboot.ITalkToolbar;
import com.ameron32.trials.tapnotesreboot.OnItemClickListener;
import com.ameron32.trials.tapnotesreboot.R;
import com.ameron32.trials.tapnotesreboot.adapter._DummyAdapter;
...
public class NotesFragment extends TAPFragment
  ...
  public void itemClicked(View v, int position) {
    if (mCallbacks != null) {
      mSnackBar.toast(position + " clicked.");
