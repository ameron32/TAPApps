...
/**
 * imported from github from author chiuki
 * https://github.com/chiuki/sliding-pane-layout/blob/master/app/src/main/java/com/sqisland/android/sliding_pane_layout/CrossFadeSlidingPaneLayout.java
 * -------------------------
 * related blog post
